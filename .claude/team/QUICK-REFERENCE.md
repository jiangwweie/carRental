...
mcp__filesystem__read_multiple_files:
  paths:
    ...
    - backend/app/application/order_pipeline.py
...
**权限边界**:
- ✅ `backend/app/`, `config/`, `tests/` (与 QA 协作)
- ❌ `web-front/`
...
mcp__filesystem__read_multiple_files:
  paths:
    - web-front/src/components/RentalForm.tsx
    - web-front/src/types/rental.ts
...
mcp__filesystem__read_multiple_files:
  paths:
    - backend/app/domain/risk_manager.py
    - backend/app/application/rental_engine.py
...
# 3. 代码完成后检查
/simplify backend/app/domain/risk_manager.py
/type-check backend/app/domain/
